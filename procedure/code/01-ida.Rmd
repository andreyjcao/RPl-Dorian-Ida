...
- Help from fellow student Elise Chan
...
```{r chunk setup, include = FALSE, message = FALSE, warning = FALSE}
...
### START HERE Load the original search results (planned deviation)
...
### Select and save counties of interest and find density (planned deviation)
...
ggplot() +
  geom_sf(data = counties, 
    aes(fill = cut_interval(idarate, 5)), color = "grey", lwd=0.01) +
  scale_fill_brewer(palette = "GnBu") +
